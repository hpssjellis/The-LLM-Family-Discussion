# The-LLM-Family-Discussion
Getting an LLM to talk about an issue from the other LLM's point of view


1. [Social-scrolling-cognitive-loss.md](Social-scrolling-cognitive-loss.md)
